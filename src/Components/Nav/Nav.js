...
const Nav = () => {
    return (
      ...
      <div>
        ...
        <Link to={'/'}>  <a class="btn border-0 normal-case  lg:text-3xl shadow-xl font-extrabold text-transparent text-2xl bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600 ">
          
          
          <img src='https://i.ibb.co/BNzWf7n/4c84609345e0209d6c3ad3cdfbad6772-removebg-preview.png' className='logo'></img></a>
        ...
        <Link to={'/'}>  <a class="border-0 normal-case  lg:text-3xl shadow-xl font-extrabold text-transparent text-2xl bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600 ">
          ...
          <img src='https://img.freepik.com/free-vector/illustration-user-avatar-icon_53876-5907.jpg?w=740&t=st=1664438334~exp=1664438934~hmac=0016965ad116600cb6652f5d7b746563fea82560b48fc4af4c408e809446951e' className='logo'></img></a>
             ...
             <Link to={'/about'}> <li className='list-none text 1xl p-2 mx-4 hidden lg:block'><a> Outlet</a></li></Link>
